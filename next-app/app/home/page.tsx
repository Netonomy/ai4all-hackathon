...
export default function Home() {
  ...
  return (
    <div className="flex flex-1 flex-col w-full items-center gap-4 pt-8 pl-4 pr-4 overflow-y-auto lg:grid grid-cols-[0.8fr,1.3fr,0.8fr] lg:items-start  lg:pt-0  lg:pr-12 lg:pl-12 bg-[#f7f7f7] dark:bg-[#080808]">
